...
$conn = new mysqli('sql310.infinityfree.com', 'if0_40054126', '1p4N2CwtBw');
...
$sql = "CREATE DATABASE IF NOT EXISTS if0_40054126_exlence";
...
// Select the database
$conn->select_db('if0_40054126_exlence');
