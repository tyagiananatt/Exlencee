...
<head>
    ...
    <style>
        ...
        /* Layout scaffolding for dashboard tiles */
        .responsive-wrapper {
            max-width: 1400px;
            margin: 0 auto;
            padding: 0 10px;
        ...
        /* Header compaction for medium screens where buttons were clipping */
        @media (max-width: 900px) {
            ...
            /* Offset content for taller wrapped header */
            main {
                padding-top: 120px;
            }
            /* Solid header background on small screens */
            .header {
                background: #ffffff;
            }
        }
        ...
        @media (max-width: 640px) {
            ...
            .nav-buttons .nav-button i {
                font-size: 0.9rem;
            }
            /* Center the profile/avatar section under the buttons */
            .profile-section {
                width: 100%;
                justify-content: space-evenly;
                gap: 8px;
            ...
            .header-navigation.mobile-active .nav-link {
                padding: 10px 0;
                border-bottom: 1px solid #eee;
                text-align: center;
                margin: 0;
            ...
            /* Compact profile/time badges on mobile */
            .profile-section {
                width: 100%;
                justify-content: space-evenly;
                gap: 8px;
            ...
            /* Mobile card animations - reduce intensity */
            .card:hover {
            ...
            /* Disable decorative floating/rotation on mobile to avoid overlap */
            .floating-element {
            ...
            /* Make hero compact on phones and show all tiles fully */
            .hero-section {
                min-height: auto;
                padding: 16px 12px;
            }
            ...
            /* Extra offset on very small screens */
            main {
                padding-top: 140px;
            }
        }
...
<body>
                ...
                <div class="card-grid">
                        ...
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/courses.jpeg" alt="Courses" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                                <h3>My Courses</h3>
                            </div>
                        </div>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/timetable.jpeg" alt="Timetable" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                                <h3>Time Table</h3>
                            </div>
                        </div>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/progress.jpeg" alt="Progress" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                                <h3>Progress</h3>
                            </div>
                        </div>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/todo.jpeg" alt="Todo" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                                <h3>TO-Do list</h3>
                            </div>
                        </div>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/mentor.jpeg" alt="Mentor" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                                <h3>Ask Mentor</h3>
                            </div>
                        </div>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/focus.png" alt="Focus Mode" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                                <h3>Focus Mode</h3>
                            </div>
                        </div>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/doubtchat.jpeg" alt="Doubt Chat" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                                <h3>Doubt Chat</h3>
                            </div>
                        </div>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/doubtsession.jpeg" alt="Doubt Session" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                    ...
                    <!-- <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/reminder.jpeg" alt="Daily Reminders" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
                    ...
                    <article class="card">
                        <div class="card-header">
                            <div>
                                <span class="card-image">
                                    <img src="icons/notessumission.jpeg" alt="Notes Submission" onerror="this.src='data:image/svg+xml;base64,'">
                                </span>
    ...
    <script>
        ...
        document.querySelectorAll('.card').forEach(card => {
            ...
            // Make the entire card clickable to the first footer link
            const viewLink = card.querySelector('.card-footer a');
            if (viewLink) {
                card.style.cursor = 'pointer';
                card.addEventListener('click', (evt) => {
                    // Avoid double navigating if inner controls are clicked
                    const path = evt.composedPath ? evt.composedPath() : (evt.path || []);
                    if (path && path.find && path.find(el => el === viewLink)) return;
                    if (evt.target.closest && evt.target.closest('.card-footer a')) return;
