...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $form_confirm_password = trim($_POST['confirm_password']);

    // Validate input
    if (empty($form_name) || empty($form_username) || empty($form_email) || empty($form_password)) {
        ...
        if ($result->num_rows > 0) {
            ...
            $stmt->bind_param("ssss", $form_name, $form_username, $form_email, $hashed_password);
...
<body>
    <div class="signup-container">
        <div class="signup-header">
            ...
            <p>Join ExLence and start your learning journey</p>
        </div>
